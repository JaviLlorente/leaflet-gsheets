			...
			marker.on({
			  click: function (e) {
				...
				if (fotografia.includes("drive.google.com") == true)  {
					...
					'El enlace a fotos desde el mapa ha dejado de funcionar. Si quieres descargar la foto, busca el atropello en la Base de datos'
					//'<a href="' + e.target.feature.properties.Foto + '" target="_blank" rel="noopener noreferrer" >Descarga la foto del atropello</a><br/>' +
